...
public class TaskRepositoryJDBCImpl implements TaskRepository {
    ...
    public static TaskRepositoryJDBCImpl getInstance(Context context) {
        return new TaskRepositoryJDBCImpl(context);
    }

    private DataBaseJDBCHelper helper;

    private TaskRepositoryJDBCImpl(Context context) {
        helper = DataBaseJDBCHelper.getInstance(context);
    }
