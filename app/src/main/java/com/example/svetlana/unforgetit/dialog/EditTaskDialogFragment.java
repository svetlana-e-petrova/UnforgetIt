package com.example.svetlana.unforgetit.dialog;
...
public class EditTaskDialogFragment extends DialogFragment {
    ...
    public static EditTaskDialogFragment newInstance(ModelTask task) {
        ...
        args.putString("updateTitle", task.getTitle());
        args.putLong("updateDate", task.getDate());
        args.putInt("updatePriority", task.getPriority());
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String title = args.getString("updateTitle");
        long date = args.getLong("updateDate", 0);
        int priority = args.getInt("updatePriority", 0);
        long timeStamp = args.getLong("time_priority", 0);

        final ModelTask task = new ModelTask(title, date, timeStamp, priority, 0);
        ...
        alertDialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                ...
                if (etTitle.length() == 0) {
                    ...
                    tilTitle.setError(getResources().getString(R.string.dialod_error_empty_title));
                }
