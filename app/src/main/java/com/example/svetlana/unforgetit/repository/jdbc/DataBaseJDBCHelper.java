...
public class DataBaseJDBCHelper extends SQLiteOpenHelper {
    ...
    private static DataBaseJDBCHelper helper;

    synchronized static DataBaseJDBCHelper getInstance(Context context) {
